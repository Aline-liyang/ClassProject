            ...
            switch (choice) {
                ...
                case 3: {
                    ...
                    while (keyreturnRes.equalsIgnoreCase("y")) {
                        ...
                        System.out.println("1. Create/add one result info ");
                        System.out.println("2. Delete one result info ");
                        System.out.println("3. Display all results' infomation ");
                        System.out.println("4. Search one result info ");
                        System.out.println("5. Modify one result info ");
                        ...
                        switch (choiceR) {
                            case 1: {
                                daoResult.create();
                                System.out.println("Press <Enter> to return to the result menu.");
                                sc.nextLine();
                                sc.nextLine();
                                keyreturnRes = "y";
                                break;
